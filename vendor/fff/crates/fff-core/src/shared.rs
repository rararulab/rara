...
use crate::{
    error::Error, file_picker::FilePicker, frecency::FrecencyTracker, git::GitStatusCache,
...
/// `Default` creates an empty handle suitable for
/// `Lazy::new(SharedPicker::default)`.
