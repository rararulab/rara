...
//! powered by [frizbee](https://docs.rs/neo_frizbee), frecency scoring backed by LMDB,
...
//!   filesystem for changes, and performs fuzzy search with frecency-weighted
//!   scoring.
//! - [`frecency::FrecencyTracker`] — LMDB-backed database that tracks file
//!   access and modification patterns for intelligent result ranking.
...
//!     frecency::FrecencyTracker, query_tracker::QueryTracker,
//! };
//!
...
/// Path manipulation utilities: cross platform canonicalization, tilde
/// expansion, and directory distance penalties for search scoring.
pub mod path_utils;
