...
- **cmd**: Make `setup boxlite` self-sufficient via release tarball download ([#1980](https://github.com/rararulab/rara/issues/1980)) ([#1984](https://github.com/rararulab/rara/issues/1984))
...
- **cmd**: GC stale boxlite runtime sibling dirs after staging ([#2097](https://github.com/rararulab/rara/issues/2097)) ([#2098](https://github.com/rararulab/rara/issues/2098))
...
- Restore real CI as the merge gate (GitHub-hosted runners + required checks) ([#2166](https://github.com/rararulab/rara/issues/2166)) ([#2170](https://github.com/rararulab/rara/issues/2170))
...
- **cmd**: Derive BOXLITE_VERSION from Cargo.lock at build time ([#2099](https://github.com/rararulab/rara/issues/2099)) ([#2100](https://github.com/rararulab/rara/issues/2100))
