...
impl ChatAgent {
    ...
    pub async fn run(
    ...
    ) -> Result<(AgentOutput, Option<CompactionEffect>), KernelError> {
        let PrepareResult {
            runner,
            effective_tools,
            compaction,
        ...
        let result = runner.run(&effective_tools, None).await?;
    ...
    pub async fn prepare_streaming(
        ...
        model: &str,
        context_length: usize,
    ) -> Result<ChatAgentStreamSetup, KernelError> {
        let PrepareResult {
            runner,
            effective_tools,
            compaction,
    ...
    async fn prepare(
        ...
        model: &str,
        context_length: usize,
    ) -> Result<PrepareResult, KernelError> {
