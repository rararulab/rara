...
- **memory**: Commit_outcome API + confidence-weighted search ranking ([#2112](https://github.com/rararulab/rara/issues/2112)) ([#2121](https://github.com/rararulab/rara/issues/2121))
...
- **clippy**: Fix clippy 1.97 toolchain-drift lints ([#2220](https://github.com/rararulab/rara/issues/2220)) ([#2222](https://github.com/rararulab/rara/issues/2222))
...
- **kernel**: Remove duplicate CommandInfo, orphan PhotoAttachment, redundant session_key fields ([#2105](https://github.com/rararulab/rara/issues/2105)) ([#2110](https://github.com/rararulab/rara/issues/2110))
