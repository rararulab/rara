...
- **memory**: Confidence column + memory_outcomes audit table ([#2111](https://github.com/rararulab/rara/issues/2111)) ([#2119](https://github.com/rararulab/rara/issues/2119))
...
- **db**: Squash migrations into single init baseline ([#1740](https://github.com/rararulab/rara/issues/1740)) ([#1742](https://github.com/rararulab/rara/issues/1742))
