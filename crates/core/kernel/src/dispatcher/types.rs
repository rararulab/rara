...
pub struct AgentTask {
    ...
    pub message:     String,
    /// Pre-converted conversation history.
    ///
    /// Workers convert `ChatMessage` → `ChatCompletionRequestMessage` before
    /// submitting.  The [`TaskExecutor`] passes this directly to the agent
    /// runner.
    #[builder(default)]
