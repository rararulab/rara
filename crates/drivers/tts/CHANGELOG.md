...
- **drivers**: Create rara-tts crate with OpenAI-compatible TTS client ([#1162](https://github.com/rararulab/rara/issues/1162)) ([#1167](https://github.com/rararulab/rara/issues/1167))
