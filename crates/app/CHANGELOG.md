...
- **kernel**: Surface failed turns as traces + OpenRouter e2e provider with preflight ([#2178](https://github.com/rararulab/rara/issues/2178)) ([#2183](https://github.com/rararulab/rara/issues/2183))
- **app**: Reclaim in-flight-exec sandbox VM at session end ([#1866](https://github.com/rararulab/rara/issues/1866)) ([#2219](https://github.com/rararulab/rara/issues/2219))
- **app**: Bound run_code exec with a timeout ([#2217](https://github.com/rararulab/rara/issues/2217)) ([#2231](https://github.com/rararulab/rara/issues/2231))
- **data-feeds**: Preserve running feed on deferred updates ([#2251](https://github.com/rararulab/rara/issues/2251))
- **finance**: Scope instrument feed subscriptions ([#2255](https://github.com/rararulab/rara/issues/2255))
- **finance**: Classify missing diagnostic feeds as unconfigured ([#2257](https://github.com/rararulab/rara/issues/2257))
- **finance**: Preserve configured feed transport ([#2258](https://github.com/rararulab/rara/issues/2258))
- **finance**: Diagnose disabled feeds as unconfigured ([#2259](https://github.com/rararulab/rara/issues/2259))
- **finance**: Normalize candle ingestion selectors ([#2264](https://github.com/rararulab/rara/issues/2264))
- **finance**: Normalize existing feed selectors ([#2265](https://github.com/rararulab/rara/issues/2265))
- **finance**: Normalize listed feed selectors ([#2266](https://github.com/rararulab/rara/issues/2266))
- **finance**: Normalize feed tool configs ([#2270](https://github.com/rararulab/rara/issues/2270))
- **finance**: Normalize restarted market candle feeds ([#2272](https://github.com/rararulab/rara/issues/2272))
- **finance**: Normalize subscribed market candle feeds ([#2273](https://github.com/rararulab/rara/issues/2273))
- **finance**: Fallback when market data schema init fails ([#2275](https://github.com/rararulab/rara/issues/2275))
- **finance**: Reject mismatched candle venues ([#2320](https://github.com/rararulab/rara/issues/2320))
...
- **finance**: Document candle query tools ([#2253](https://github.com/rararulab/rara/issues/2253))
...
- **memory**: Explain() API to trace which memory items shaped a turn ([#2113](https://github.com/rararulab/rara/issues/2113)) ([#2123](https://github.com/rararulab/rara/issues/2123))
- **sandbox**: Default-deny egress for run_code — operator allow-list only ([#2216](https://github.com/rararulab/rara/issues/2216)) ([#2230](https://github.com/rararulab/rara/issues/2230))
...
- **finance**: Enable catalog feed sources ([#2242](https://github.com/rararulab/rara/issues/2242))
- **finance**: Subscribe candle instruments ([#2243](https://github.com/rararulab/rara/issues/2243))
- **finance**: Diagnose candle subscriptions ([#2245](https://github.com/rararulab/rara/issues/2245))
- **finance**: Show feed source runtime status ([#2246](https://github.com/rararulab/rara/issues/2246))
- **finance**: Control feed source lifecycle ([#2247](https://github.com/rararulab/rara/issues/2247))
- **finance**: Show feed event health in source list ([#2248](https://github.com/rararulab/rara/issues/2248))
- **finance**: Include feed event health in diagnostics ([#2252](https://github.com/rararulab/rara/issues/2252))
- **finance**: Add news subscription tool ([#2279](https://github.com/rararulab/rara/issues/2279))
- **finance**: Show source subscription status ([#2281](https://github.com/rararulab/rara/issues/2281))
- **finance**: Show catalog subscription state in UI ([#2282](https://github.com/rararulab/rara/issues/2282))
- **finance**: Enrich subscription listing ([#2284](https://github.com/rararulab/rara/issues/2284))
- **finance**: Support selector-based unsubscribe ([#2285](https://github.com/rararulab/rara/issues/2285))
- **finance**: Expose candle stream watermarks ([#2296](https://github.com/rararulab/rara/issues/2296))
- **finance**: Expose recent candle queries ([#2314](https://github.com/rararulab/rara/issues/2314))
- **finance**: List recent feed events ([#2315](https://github.com/rararulab/rara/issues/2315))
- **finance**: Filter feed events by kind ([#2316](https://github.com/rararulab/rara/issues/2316))
- **finance**: Expose feed selectors in diagnostics ([#2318](https://github.com/rararulab/rara/issues/2318))
- **finance**: Diagnose selector coverage ([#2319](https://github.com/rararulab/rara/issues/2319))
- **finance**: Report latest feed event type ([#2321](https://github.com/rararulab/rara/issues/2321))
- **finance**: Expose feed source providers ([#2322](https://github.com/rararulab/rara/issues/2322))
- **finance**: Expose subscription source providers
- **finance**: Report feed providers in diagnostics
- **finance**: Report catalog sources in diagnostics
- **finance**: Explain candle diagnostic status ([#2328](https://github.com/rararulab/rara/issues/2328))
- **finance**: Default instrument subscriptions to binance ([#2329](https://github.com/rararulab/rara/issues/2329))
- **finance**: Hint candle diagnostics after subscription ([#2330](https://github.com/rararulab/rara/issues/2330))
- **finance**: Expose diagnostics from subscription list ([#2331](https://github.com/rararulab/rara/issues/2331))
- **finance**: Echo candle diagnosis query ([#2396](https://github.com/rararulab/rara/issues/2396))
- **finance**: Surface bundle subscription hints ([#2403](https://github.com/rararulab/rara/issues/2403))
- **finance**: Surface bundle market data hints ([#2404](https://github.com/rararulab/rara/issues/2404))
- **finance**: Expose configure hints for feed sources ([#2409](https://github.com/rararulab/rara/issues/2409))
- **finance**: Summarize feed bundle source status ([#2410](https://github.com/rararulab/rara/issues/2410))
- **finance**: Return bundle status after subscription ([#2411](https://github.com/rararulab/rara/issues/2411))
...
- **finance**: Surface subscription follow-up hints ([#2454](https://github.com/rararulab/rara/issues/2454))
- **finance**: Expose feed bundle quick starts ([#2455](https://github.com/rararulab/rara/issues/2455))
- Prepare rara for Flux deployment ([#2479](https://github.com/rararulab/rara/issues/2479))
...
- Mechanical cleanup pass — unwrap → expect, CJK comments → English, wildcard import ([#2071](https://github.com/rararulab/rara/issues/2071)) ([#2072](https://github.com/rararulab/rara/issues/2072))
- **dev-workflow**: Integrate portless for stable .localhost URLs per worktree ([#2114](https://github.com/rararulab/rara/issues/2114)) ([#2118](https://github.com/rararulab/rara/issues/2118))
- **lint**: Mechanize style rules into workspace lints + ratchet + Go/Zig gates ([#2174](https://github.com/rararulab/rara/issues/2174)) ([#2185](https://github.com/rararulab/rara/issues/2185))
- **ci**: Retire real-LLM e2e — wiremock mock provider over SSE ([#2190](https://github.com/rararulab/rara/issues/2190)) ([#2191](https://github.com/rararulab/rara/issues/2191))
...
- **channels**: TelegramAdapter bon::Builder, drop set_*_handlers setters ([#2109](https://github.com/rararulab/rara/issues/2109)) ([#2117](https://github.com/rararulab/rara/issues/2117))
- **kernel**: Collapse 4 endpoint mappings, remove dead EndpointRegistry ([#2108](https://github.com/rararulab/rara/issues/2108)) ([#2122](https://github.com/rararulab/rara/issues/2122))
...
- **finance**: Cover candle dispatch query path ([#2274](https://github.com/rararulab/rara/issues/2274))
- **finance**: Cover market data tool registration ([#2294](https://github.com/rararulab/rara/issues/2294))
- **finance**: Cover candle tool discovery ([#2295](https://github.com/rararulab/rara/issues/2295))
