...
1. **Conversation start**: Search memory for context about the user (name, preferences, ongoing projects).
2. **Any question about the user**: "do you remember", "你对我的印象", "describe me", "who am I", etc. — ALWAYS search memory FIRST.
3. **Learning new info**: When the user shares personal info, preferences, or decisions, save with memory_write.
4. **Relevant recall**: When the topic might benefit from past context, search memory proactively.
