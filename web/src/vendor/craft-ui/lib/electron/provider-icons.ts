 ...
 * Source: https://github.com/lukilabs/craft-agents-oss/blob/d9c585b8a1e5dc4557e3006b0fffaaa587f5dbb7/apps/electron/src/renderer/lib/provider-icons.ts
 */
/**
 * Provider Icons
 *
...
import awsIcon from '~vendor/assets/provider-icons/aws.svg'
import azureIcon from '~vendor/assets/provider-icons/azure.svg'
import claudeIcon from '~vendor/assets/provider-icons/claude.svg'
import copilotIcon from '~vendor/assets/provider-icons/copilot.svg'
import googleIcon from '~vendor/assets/provider-icons/google.svg'
import huggingfaceIcon from '~vendor/assets/provider-icons/huggingface.svg'
import kimiIcon from '~vendor/assets/provider-icons/kimi.svg'
import minimaxIcon from '~vendor/assets/provider-icons/minimax.svg'
import mistralIcon from '~vendor/assets/provider-icons/mistral.svg'
import ollamaIcon from '~vendor/assets/provider-icons/ollama.svg'
import openaiIcon from '~vendor/assets/provider-icons/openai.svg'
import openrouterIcon from '~vendor/assets/provider-icons/openrouter.svg'
import piIcon from '~vendor/assets/provider-icons/pi.svg'
import vercelIcon from '~vendor/assets/provider-icons/vercel.svg'
