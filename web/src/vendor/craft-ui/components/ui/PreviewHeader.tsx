 ...
 * Source: https://github.com/lukilabs/craft-agents-oss/blob/d9c585b8a1e5dc4557e3006b0fffaaa587f5dbb7/packages/ui/src/components/ui/PreviewHeader.tsx
 *
 * Local modifications: import `useTranslation` from local `i18n-shim`
 * (rara does not ship react-i18next).
 */
